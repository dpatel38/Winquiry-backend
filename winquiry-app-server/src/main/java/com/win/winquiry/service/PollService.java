package com.win.winquiry.service;

import com.win.winquiry.exception.BadRequestException;
import com.win.winquiry.exception.ResourceNotFoundException;
import com.win.winquiry.model.*;
import com.win.winquiry.payload.PagedResponse;
import com.win.winquiry.payload.PollRequest;
import com.win.winquiry.payload.PollResponse;
import com.win.winquiry.payload.VoteRequest;
import com.win.winquiry.repository.ChoiceRepository;
...
import com.win.winquiry.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        User creator = userRepository.findById(poll.getCreatedBy())
                .orElseThrow(() -> new ResourceNotFoundException("User", "id", poll.getUpdatedBy()));
